...
<div class="row border-bottom bd-lightGray mt-4">
    ...
    <div class="col-md-8 d-flex flex-justify-center flex-justify-end-md">
        <ul class="breadcrumbs bg-transparent m-0">
            ...
            <li class="page-item"><a class="page-link" href="#">Edit ngành nghề</a></li>
        </ul>
    </div>
</div>
                ...
                <form class="ui form" action="" method="post" name="form_1">
                    ...
                    <div class="row flex-align-end">
                        <div class="form-group col-sm-6 mt-0">
                            ...
                            <input type="text" data-role="input" name="loainganh_jp" value="{{ $nganhnghe->loainganh_jp }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Loại ngành tiếng Việt</h6>
                            <input type="text" data-role="input" name="loainganh_vn" value="{{ $nganhnghe->loainganh_vn }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Tên tiếng Nhật</h6>
                            <input type="text" data-role="input" name="name_jp" value="{{ $nganhnghe->name_jp }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Tên tiếng Việt</h6>
                            <input type="text" data-role="input" name="name_vn" value="{{ $nganhnghe->name_vn }}" >
                        </div>
