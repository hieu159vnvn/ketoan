...
<div class="row border-bottom bd-lightGray mt-4">
    ...
    <div class="col-md-8 d-flex flex-justify-center flex-justify-end-md">
        <ul class="breadcrumbs bg-transparent m-0">
            ...
            <li class="page-item"><a class="page-link" href="#">In hóa đơn đào tạo</a></li>
        </ul>
    </div>
</div>
                ...
                <div class="bg-white p-4">
                    ...
                    <div  id="tableprint">
                        ...
                        <table id="tableprintExcel" class="table " cellspacing="0" cellpadding="0">
                            <tr>
                                <td colspan="6" style="text-align: center"><h3><strong>御請求書 <br>ĐỀ NGHỊ THANH TOÁN</strong></h3></td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><strong>MIRAI HUMAN RESOURCE CO.,LTD</strong><br>26/4-26/5 Le Thanh Ton St, Ben Nghe Ward,</td>
                            </tr>
                            <tr>
                                <td colspan="2">{{$nghiepdoan->add_jp}}<br>{{$nghiepdoan->add_vn}}</td>
                                <td></td>
                                <td colspan="3">Dist.1, Ho Chi Minh City, Viet Nam<br>TEL : (84.28) 6686 3208</td>
                            </tr>
                            <tr>
                                <td colspan="2">TEL : {{$nghiepdoan->tel}}</td>
                                <td></td>
                                <td colspan="3">FAX: (84.28) 3873 3268</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="6">毎度有難うございます。</td>
                            </tr>
                            <tr>
                                <td colspan="6">下記の通り講習費用のご請求申し上げます。<br>Vui lòng thanh toán phí đào tạo theo bảng kê dưới đây.</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="5">{{$nganhang->tennh}}</td>
                            </tr>
                            <tr>
                                <td>支店名<br>Tên chi nhánh</td>
                                <td colspan="2">{{$nganhang->chinhanh}}</td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">{{$nganhang->tentk}}</td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>手数料<br>Phí chuyển khoản</td>
                                <td colspan="3">振込み手数料はお客様のご負担となります</td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>支払期限<br>Thời hạn thanh toán</td>
                                <td colspan="2">{{date("Y",strtotime("+1 month",strtotime($date_created)))}}  年  {{date("m",strtotime("+1 month",strtotime($date_created)))}} 月 {{date("d",strtotime("+1 month",strtotime($date_created)))}} 日まで</td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
