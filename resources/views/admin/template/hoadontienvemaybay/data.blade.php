                    ...
                    <div class="form-group mt-0 d-flex" style="justify-content: space-between">
                        <div class="d-flex">
                            ...
                            <select style="width:300px;"name="nghiepdoan" data-role="select" id="select-nd" >
                                ...
                                <option value="/hoadontienvemaybay/{{$item->id}}" {{ $item->id ==  $id_ndoan  ? 'selected' : '' }}>{{$item->name_vn}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <form method="POST" action="/inhoadontienvemaybay/{{$id_ndoan}}">
                        {{ csrf_field() }}
                        ...
                        <table class="table" id="hoadontienquanly" cellspacing="0" cellpadding="0">
                            ...
                            @foreach($hocvien as $item)
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000;text-align:center">¥{{$item->sohocvien*15000}}</td>
                                </tr>
                            @endforeach
                        </table>
