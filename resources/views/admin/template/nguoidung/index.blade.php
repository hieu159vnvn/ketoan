                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <div style="text-align: center;color:white;width:77px">
                                                ...
                                                <a onclick="return confirm('Bạn có chắc chắn muốn xóa? Lưu ý sau khi xóa sẽ không phục hồi lại được')" href="{{ $item->id == 1  ? '#' : "/deletenguoidung/$item->id" }}"  class="mt-1 button cycle square alert btn-delete"><span class="mif-cross"></span></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
