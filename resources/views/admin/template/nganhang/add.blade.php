...
<div class="row border-bottom bd-lightGray mt-4">
    <div class="col-md-4 text-center text-left-md">
        <h3 class="content_title m-0">Thêm ngân hàng</h3>
    </div>
    <div class="col-md-8 d-flex flex-justify-center flex-justify-end-md">
        <ul class="breadcrumbs bg-transparent m-0">
            ...
            <li class="page-item"><a class="page-link" href="#">Thêm ngân hàng</a></li>
        </ul>
    </div>
</div>
                ...
                <form class="ui form" action="" method="post" name="form_1">
                    ...
                    <div class="row flex-align-end">
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Tên ngân hàng</h6>
                            <input type="text" data-role="input" name="tennh" value="{{ old('tennh') }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Chi nhánh</h6>
                            <input type="text" data-role="input" name="chinhanh" value="{{ old('chinhanh') }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Số chi nhánh</h6>
                            <input type="number" data-role="input" name="sochinhanh" value="{{ old('sochinhanh') }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Địa chỉ</h6>
                            <input type="text" data-role="input" name="dc" value="{{ old('dc') }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Số điện thoại</h6>
                            <input type="text" data-role="input" name="sdt" value="{{ old('sdt') }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Swift code</h6>
                            <input type="text" data-role="input" name="swiftcode" value="{{ old('swiftcode') }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Số tài khoản</h6>
                            <input type="number" data-role="input" name="sotk" value="{{ old('sotk') }}" >
                        </div>
                        <div class="form-group col-sm-6 mt-0">
                            <h6>Tên tài khoản</h6>
                            <input type="text" data-role="input" name="tentk" value="{{ old('tentk') }}" >
                        </div>
